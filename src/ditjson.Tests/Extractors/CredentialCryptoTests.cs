...
public class CredentialCryptoTests
{
    ...
    [TestMethod]
    public void TransformKey_MatchesMsSamrVector() => Assert.AreSequenceEqual(Convert.FromHexString("008080604028180E"), CredentialCrypto.TransformKey(Convert.FromHexString("01020304050607")));
